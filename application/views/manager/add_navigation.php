                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-table"></i><a href=<?php echo site_url('manager/left_navigation');?>> ზედა გვერდები</a>
                            </li>
                            <li class="active">
                             <i class="fa fa-table"></i> მარცხენა გვერდის დამატება
                            </li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                            <div class="form-group">
                                <label>სათაური</label>
                            <form action="<?php echo site_url('manager/insert_navigation'); ?>" method="post">
